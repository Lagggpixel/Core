...
import me.lagggpixel.core.modules.guilds.managers.ClaimManager;
...
public class Claim {
  ...
  public boolean isNearby(Location l) {
    ...
    if (getWorld() == (new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).getWorld()) {
      if (isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(0.0D, 0.0D, CLAIM_BUFFER), false)) {
        return true;
      }
      if (isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(CLAIM_BUFFER, 0.0D, 0.0D), false)) {
        return true;
      }
      if (isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(0.0D, 0.0D, -CLAIM_BUFFER), true)) {
        return true;
      }
      if (isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(-CLAIM_BUFFER, 0.0D, 0.0D), true)) {
        return true;
      }
      if (isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(-CLAIM_BUFFER, 0.0D, CLAIM_BUFFER), false)) {
        return true;
      }
