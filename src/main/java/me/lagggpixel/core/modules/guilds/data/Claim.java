...
public class Claim {
  ...
  public boolean isNearby(Location l) {
    ...
    return isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(0.0D, 0.0D, CLAIM_BUFFER), false)
        || isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(CLAIM_BUFFER, 0.0D, 0.0D), false)
        || isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(0.0D, 0.0D, -CLAIM_BUFFER), true)
        || isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(-CLAIM_BUFFER, 0.0D, 0.0D), true)
        || isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(-CLAIM_BUFFER, 0.0D, CLAIM_BUFFER), false)
        || isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(CLAIM_BUFFER, 0.0D, -CLAIM_BUFFER), false)
        || isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(-CLAIM_BUFFER, 0.0D, -CLAIM_BUFFER), false)
        || isInside((new Location(l.getWorld(), l.getX(), l.getY(), l.getZ())).add(CLAIM_BUFFER, 0.0D, CLAIM_BUFFER), false);
  }
